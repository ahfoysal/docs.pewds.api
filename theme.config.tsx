...
const config: DocsThemeConfig = {
  gitTimestamp: false,
  useNextSeoProps: () => {
    return { titleTemplate: `%s - Pewds` };
  },
  faviconGlyph: "🚧",
  banner: {
    text: "🚧 The Pewds api documentation is undergoing reconstruction. Please be patient for all providers to be fully-documented. 🚧",
  },
  logo: <span>Pewds Api Documentation</span>,
  navbar: {
    extraContent: () => {
  ...
  footer: {
    text: "Copyright (c) Pewds | 2023-present",
  },
  head: function useHead() {
    const description =
      "A collection of documentation for each provider available on Pewds Api. Find out how to efficiently use the Pewds API here!";
    return (
      <>

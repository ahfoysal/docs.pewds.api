---
title: Fetch Categories and Nav 
---
...
```
https://api.pewds.vercel.app/daraz/categories/
```

```
https://api.pewds.vercel.app/daraz/all-categories/
```
...
<Tabs items={["JavaScript"]}>
  <Tab>
    <>
        ...
        const url = "https://api.pewds.vercel.app/daraz/categories/";
        const data = async () => {
            try {
